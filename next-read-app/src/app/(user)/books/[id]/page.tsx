...
export default async function BookDetailPage({
  ...
  try {
    ...
    return (
      <main className="mx-auto max-w-[1120px] space-y-8 px-5 py-7">
        <AppNav />
        <CatalogUnavailable
  ...
  return (
    <main className="mx-auto max-w-[1120px] px-5 py-7 font-outfit text-palette-slate-50 sm:px-8">
      <AppNav />
      <nav
      ...
      >
        ...
        <Link
          ...
          href={`/book-list?category=${encodeURIComponent(book.category)}`}
        >
          {book.category}
        </Link>
        <span>›</span>
